...
urlpatterns += patterns ('',
  ...
  url(r'^p/(?P<slug>[-\w]+)/mailinglist/$', views.group_mailinglist,
      { 'extra_context' : { 'title' : _("Mailing lists") }, },
      name='group_mailinglist'),
  # VCS
  url(r'^p/(?P<slug>[-\w]+)/vcs/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("CVS Repositories") },
  ...
  url(r'^p/(?P<slug>[-\w]+)/svn/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("Subversion Repositories") },
  ...
  url(r'^p/(?P<slug>[-\w]+)/arch/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("GNU Arch Repositories") },
  ...
  url(r'^p/(?P<slug>[-\w]+)/git/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("Git Repositories") },
  ...
  url(r'^p/(?P<slug>[-\w]+)/hg/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("Mercurial Repositories") },
  ...
  url(r'^p/(?P<slug>[-\w]+)/bzr/cvs/$', object_detail,
      { 'queryset' : auth_models.Group.objects.all(),
        'slug_field' : 'name',
        'extra_context' : { 'title' : _("Bazaar Repositories") },
